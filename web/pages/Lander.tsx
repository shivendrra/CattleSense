      ...
      <section className="relative min-h-[85vh] flex items-center justify-center text-center overflow-hidden">
         ...
         <div className="container mx-auto px-6 relative z-10 text-white max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
               ...
               <button onClick={() => window.open('https://youtu.be/r6QjBwqAkYo', '_blank')} className="px-8 py-4 bg-transparent border border-white/30 text-white font-medium hover:bg-white/10 transition-all rounded-sm min-w-[180px] flex items-center justify-center gap-2 backdrop-blur-sm">
