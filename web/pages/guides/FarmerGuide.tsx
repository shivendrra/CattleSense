  ...
  <div className="min-h-screen bg-white">
    ...
    <div className="container mx-auto px-6 py-16 max-w-4xl">
      ...
      <div className="mt-16 p-10 bg-gray-50 border border-gray-100 text-center rounded-sm">
        ...
        <a
          href="https://cattlesense-mobile.vercel.app/"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-block bg-darkBlue text-white px-8 py-3 rounded-md font-medium hover:bg-black transition-colors"
        >
          Get App
        </a>
      </div>
