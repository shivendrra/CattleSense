...
const Dashboard: React.FC = () => {
  ...
  // Helper to generate recent dynamic dates
  ...
  const dataClusters = [
    { id: 'DS-2401', name: 'Karnal Dairy Belt - Longitudinal AMU', size: '2.4 GB', date: getRecentDate(2), access: 'Open' },
    { id: 'DS-2402', name: 'Hisar Poultry MRL Sampling', size: '1.1 GB', date: getRecentDate(5), access: 'Restricted' },
    { id: 'DS-2403', name: 'Gurugram Peri-urban Livestock Census', size: '850 MB', date: getRecentDate(12), access: 'Open' },
  ];
